-- Update the compact function with batch size of 200
...
DECLARE
  ...
  unit_record RECORD;
  date_record RECORD;
  batch_limit INTEGER := 200; -- Delete in batches of 200 for faster cleanup
BEGIN
  ...
  -- Deletar registros antigos do histórico detalhado (em lotes de 200)
  WITH deleted AS (
