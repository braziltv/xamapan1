...
serve(async (req) => {
  ...
  try {
    ...
    // Vozes disponíveis:
    // - Alice (Xb7hH8MSUJpSbSDYk0k2): voz feminina natural para anúncios
    // - Brian (onwK4e9ZLuTAKqWW03F9): voz masculina grave para "Repita"
    // Se voiceId for passado, usa ele; senão usa Alice como padrão
