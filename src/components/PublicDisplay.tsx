...
export function PublicDisplay(_props: PublicDisplayProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mb-[0.3vh] shrink-0">
        <div className="bg-gradient-to-r from-indigo-900/95 via-purple-900/95 to-indigo-900/95 backdrop-blur-xl rounded-2xl px-[1vw] py-[0.6vh] shadow-2xl border border-white/20 relative overflow-hidden">
          {/* Decorative glow */}
          ...
          <div className="flex items-center gap-[0.8vw] relative z-10">
            ...
            <div className="flex items-center gap-[0.5vw] shrink-0">
              <div className="w-[4vw] h-[4vw] min-w-[45px] min-h-[45px] rounded-xl bg-white/90 flex items-center justify-center shadow-lg shrink-0">
                <HealthCrossIcon size={36} className="w-[3vw] h-[3vw] min-w-[32px] min-h-[32px]" />
              </div>
              <div className="min-w-0">
                <h1 className="font-bold text-white leading-tight whitespace-nowrap" style={{ fontSize: 'clamp(1.1rem, 1.8vw, 2.2rem)' }}>
                  Painel de Chamadas
                </h1>
                <p className="text-amber-300 leading-tight font-medium" style={{ fontSize: 'clamp(0.6rem, 1vw, 1.2rem)' }}>
